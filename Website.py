...
lottie_coding3 = load("https://assets7.lottiefiles.com/packages/lf20_nu782hb5.json")
lottie_coding4 = load("https://assets9.lottiefiles.com/private_files/lf30_ISHFyg.json")
...
with slt.container():
    ...
    slt.write('---')
    slt.header(':speech_balloon: My Projects')
    image_column , text_column = slt.columns((1,2))
    with image_column:
        st_lottie(lottie_coding3,height=250,key="editor")
    with text_column:
...
with slt.container():
    ...
    image_column , text_column = slt.columns((1,2))
    with image_column:
        st_lottie(lottie_coding4,height=250,key="login")
    with text_column:
